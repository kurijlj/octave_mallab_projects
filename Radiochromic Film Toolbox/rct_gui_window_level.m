...
function rct_gui_window_level(data, num_bins=1024)
    ...
    cla(hist_view);
    rct_hist_plot(hist_view, data_bins, data_hist);
    hold(hist_view, 'on');
    plot( ...
        'parent', hist_view, ...
        [frame_left frame_right], [0 0], 'r', 'Linewidth', 2, ...
        [frame_right frame_right], [0 1], 'r', 'Linewidth', 2, ...
        [frame_right frame_right], [0 1], 'r', 'Linewidth', 2, ...
        [frame_right frame_right], [0 1], 'r', 'Linewidth', 2, ...
        [frame_left frame_right], [1 1], 'r', 'Linewidth', 2, ...
        [frame_left frame_left], [0 1], 'r', 'Linewidth', 2 ...
        );
    hold(hist_view, 'off');
    % hist_plot = plot( ...
    %     'parent', hist_view, ...
...
function rct_update_window_level(obj)
    ...
    switch(gcbo)
        case {h.level_selector}
            ...
            cla(h.hist_view);
            rct_hist_plot(h.hist_view, h.data_bins, h.data_hist);
            hold(h.hist_view, 'on');
            plot( ...
                'parent', h.hist_view, ...
                [frame_left frame_right], [0 0], 'r', 'Linewidth', 2, ...
