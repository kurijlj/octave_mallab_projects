...
function roi = newRoi(msr, roi_window)
    ...
    rel_dp_count = [0, 0, 0];
    rel_dp_count(1) = dp_count(1)*100/numel(roi_dp_mask(:, :, 1));
    rel_dp_count(2) = dp_count(2)*100/numel(roi_dp_mask(:, :, 2));
    rel_dp_count(3) = dp_count(3)*100/numel(roi_dp_mask(:, :, 3));
    clear('roi_dp_mask');
...
function roi_snr = roiSnr(irr, bkg, dp_mask, roi_window)
    ...
    irr_mean = [ ...
        irr_mean, ...
        mean( ...
            intmax(irr_pixel_data) ...
            - irr_pixel_data(:, :, 1)(logical(roi_dp_mask(:, :, 1))) ...
            ) ...
        ];
    irr_mean = [ ...
        irr_mean, ...
        mean( ...
            intmax(irr_pixel_data) ...
            - irr_pixel_data(:, :, 2)(logical(roi_dp_mask(:, :, 2))) ...
            ) ...
        ];
    irr_mean = [ ...
        irr_mean, ...
        mean( ...
            intmax(irr_pixel_data) ...
            - irr_pixel_data(:, :, 3)(logical(roi_dp_mask(:, :, 3))) ...
            ) ...
        ];
    bkg_std = [];
    bkg_std = [ ...
        ...
        std( ...
            intmax(irr_pixel_data) ...
            - bkg_pixel_data(:, :, 1)(logical(roi_dp_mask(:, :, 1))) ...
            ) ...
        ];
    bkg_std = [ ...
        bkg_std, ...
        std( ...
            intmax(irr_pixel_data) ...
            - bkg_pixel_data(:, :, 2)(logical(roi_dp_mask(:, :, 2))) ...
            ) ...
        ];
    bkg_std = [ ...
        bkg_std, ...
        std( ...
            intmax(irr_pixel_data) ...
            - bkg_pixel_data(:, :, 3)(logical(roi_dp_mask(:, :, 3))) ...
            ) ...
        ];
