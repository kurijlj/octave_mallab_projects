...
function [dvh_data, ...
    ...
    if(11 > how_many_lines)
        ...
        fclose(file_id);
        fprintf(stderr, ...
            "%s: ERROR: To few lines detected. Expected at least 11 lines, detected: %d.", ...
            func_name, ...
            how_many_lines ...
            );
        error("File integrity for '%s': FAILED!\n", file_path);
        return;
    ...
    if(min_line_length > length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected at least 8 characters on line: 1, detected: %d.\n", ...
            func_name, ...
            length(line) ...
            );
        ...
        if(not(field_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: field name missmatch. Expected field:'%s' on line: 1, detected field: '%s'.\n", ...
                func_name, ...
                field_name, ...
                line(1, 1:length(field_name)) ...
                );
    ...
    if((length(field_name) + 3 + length(valid_input{1, 1})) > length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected at least 17 characters on line: 2, detected: %d.\n", ...
            func_name, ...
            length(line) ...
            );
        ...
        if(not(field_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: field name missmatch. Expected field:'%s' on line: 2, detected field: '%s'.\n", ...
                func_name, ...
                field_name, ...
                line(1, 1:length(field_name)) ...
                );
        ...
        if(length(valid_input{1, 1}) == length(dvh_type))
            ...
            if(not(value_match))
                error_flag = true;
                fprintf(stderr, ...
                    "%s: ERROR: Invalid input. Expected value:'%s' on line: 2, detected value: '%s'.\n", ...
                    func_name, ...
                    valid_input{1, 1}, ...
                    dvh_type ...
                    );
    ...
    if((length(field_name) + 2 + length(valid_input{1, 2})) > length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected at least 22 characters on line: 3, detected: %d.\n", ...
            func_name, ...
            length(line) ...
            );
        ...
        if(not(field_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: field name missmatch. Expected field:'%s' on line: 3, detected field: '%s'.\n", ...
                func_name, ...
                field_name, ...
                line(1, 1:length(field_name)) ...
                );
        ...
        if(length(valid_input{1, 1}) == length(dose_algorithm))
            ...
            if(not(value_match))
                error_flag = true;
                fprintf(stderr, ...
                    "%s: ERROR: Invalid input. Expected value:'%s' on line: 3, detected value: '%s'.\n", ...
                    func_name, ...
                    valid_input{1, 1}, ...
                    dvh_type ...
                    );
    ...
    if(min_line_length > length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected at least 18 characters on line: 4, detected: %d.\n", ...
            func_name, ...
            length(line) ...
            );
        ...
        if(not(field_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: field name missmatch. Expected field:'%s' on line: 4, detected field: '%s'.\n", ...
                func_name, ...
                field_name, ...
                line(1, 1:length(field_name)) ...
                );
    ...
    if(min_line_length > length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected at least 15 characters on line: 5, detected: %d.\n", ...
            func_name, ...
            length(line) ...
            );
        ...
        if(not(field_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: field name missmatch. Expected field:'%s' on line: 5, detected field: '%s'.\n", ...
                func_name, ...
                field_name, ...
                line(1, 1:length(field_name)) ...
                );
    ...
    if(min_line_length > length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected at least 21 characters on line: 6, detected: %d.\n", ...
            func_name, ...
            length(line) ...
            );
        ...
        if(not(field_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: field name missmatch. Expected field:'%s' on line: 6, detected field: '%s'.\n", ...
                func_name, ...
                field_name, ...
                line(1, 1:length(field_name)) ...
                );
    ...
    if(valid_line_length ~= length(line))
        error_flag = true;
        fprintf(stderr, ...
            "%s: ERROR: Data length missmatch. Expected %d characters on line: 8, detected: %d.\n", ...
            func_name, ...
            valid_line_length, ...
            length(line) ...
            );
        ...
        if(not(title_match))
            error_flag = true;
            fprintf(stderr, ...
                "%s: ERROR: column title missmatch. Expected column:'%s' on line: 8, detected: '%s'.\n", ...
                func_name, ...
                column_title{1, 1}, ...
                line(1, 1:length(column_title{1, 1})) ...
                );
    ...
    if(error_flag)
        fclose(file_id);
        error("File '%s' is corrupted! Closing file and aborting operation.", ...
            file_path ...
            );
        return;
