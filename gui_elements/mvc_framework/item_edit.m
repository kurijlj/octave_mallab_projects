item_edit_version = '1.0';

% -----------------------------------------------------------------------------
%
% Function 'newItemEdit':
%
% Use:
%       -- controller = newItemEdit(controller, item)
%
% Description:
% Create an new 'Item Edit' and assign it to the parent container.
%
% -----------------------------------------------------------------------------
function controller = newItemEdit(controller)

    % Store function name into variable
    % for easier management of error messages ---------------------------------
    fname = 'newItemEdit';
    use_case = ' -- result = newItemEdit(controller)';
    ...
    position = itemEditElementsPosition(controller);
...
%
% -----------------------------------------------------------------------------
function updateEditView(controller)
...
% -----------------------------------------------------------------------------
%
% Function 'itemEditElementsPosition':
%
% Use:
%       -- position = itemEditElementsPosition(controller)
%
...
%
% -----------------------------------------------------------------------------
function position = itemEditElementsPosition(controller)
...
%
% Use:
%       -- {title, value} = getEditFieldValues(controller)
%
% Description:
% Collect data typed into edit fields.
%
% -----------------------------------------------------------------------------
function values = getEditFieldValues(controller)
