...
%
% Use:
%       -- handles = ItemView(hparent, name, uistyle, item)
%
% Description:
%          Panel containing fields for viewing items.
%
% -----------------------------------------------------------------------------
function handles = ItemView(hparent, name, uistyle, item)
    fname = 'ItemView';
    use_case_a = ' -- handles = ItemView(hparent, name, uistyle, item)';
