...
function hview = buttonPanelView(varargin)
    ...
    % Set up the view
    [hview, hbtnaccept, hbtncncl] = buttonPanelViewLayoutView( ...
        hparent, ...
        'title', title, ...
        'uistyle', uistyle, ...
    ...
    % Conect view signals to slots --------------------------------------------

    % Create controller
    cntr = buttonPanelViewController( ...
        'uistyle', uistyle, ...
        'hmaster', hfig, ...
        'hview', hview, ...
        'hbtnaccept', hbtnaccept, ...
        'hbtncncl', hbtncncl, ...
        'OnBtnPushCallback', NaN, ...
        'OnResizeCallback', @buttonPanelViewResize ...
        );

    % Connect signals to slots
    set(hfig, 'sizechangedfcn', {cntr, 'resize'});
    set(hbtnaccept, 'callback', {cntr, 'clicked'});
    set(hbtncncl, 'callback', {cntr, 'clicked'});
...
function buttonPanelViewResize(varargin)
    position = buttonPanelViewElementsPosition( ...
        get(varargin{2}, 'parent'), ...
        varargin{1} ...
        );

    set(varargin{2}, 'position', position(1, :));
    set(varargin{4}, 'position', position(2, :));
    set(varargin{3}, 'position', position(3, :));
