...
function rct_gui_test()
    ...
    row = 6;
    handles.level_label = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        'tag', 'level_label', ...
        'string', sprintf("Level: %d", value_range(1, 1)), ...
    ...
    handles.level_selector = uicontrol( ...
        ...
        'min', value_range(1, 1), 'max', value_range(1, 2), ...
        % 'value', 0.5, ...
        'position', [...
            slider_origin ...
            (row - 1)*(row_height + padding) ...
    ...
    row = 4;
    handles.level_scale_label_left = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        'tag', 'level_scale_label_left', ...
        'string', sprintf("%d", value_range(1, 1)), ...
        'horizontalalignment', 'left', ...
        'backgroundcolor', [1.00 1.00 1.00], ...
        'position', [...
            scale_label_origin ...
    ...
    row = 4;
    handles.level_scale_label_right = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        'tag', 'level_scale_label_right', ...
        'string', sprintf("%d", value_range(1, 2)), ...
    ...
    row = 3;
    handles.window_label = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        'tag', 'window_label', ...
        'string', sprintf("Window: %d", value_range(1, 1)), ...
        'horizontalalignment', 'left', ...
        'backgroundcolor', [1.00 1.00 1.00], ...
        'position', [...
            label_origin ...
    ...
    row = 1;
    handles.window_scale_label_left = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
    ...
    row = 1;
    handles.window_scale_label_right = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
