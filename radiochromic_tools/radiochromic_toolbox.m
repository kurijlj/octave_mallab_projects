...
function rct_gui_test()
    ...
    width = 2 * floor(scr_size(3) * 0.25);
    height = 2 * floor(scr_size(4) * 0.25);
    padding = 10;

    % Set Window/Level controls position, padding and extents
    row_origin = padding;
    row_width = width - 2*padding;
    row_height = 16;

    label_origin = row_origin;
    label_width = row_width;

    slider_origin = row_origin;
    slider_width = row_width;

    scale_label_origin = slider_origin + 20;
    scale_label_width = floor(slider_width / 2) - 20;
    ...
    window_value = window_max;
    level_min = value_range(1, 1) + floor(window_value / 2);
    level_max = value_range(1, 2) - floor(window_value / 2);
    level_value = level_min + floor((level_max - level_min) / 2);

    % Generate a structure of handles to pass to callbacks, and store it.
    global rct_window_level_handles;
    rct_window_level_handles = guihandles(main_window);

    rct_window_level_handles.main_window = main_window;

    row = 6;
    rct_window_level_handles.level_label = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        'tag', 'level_label', ...
        'string', sprintf("Level: %d", level_value), ...
        'horizontalalignment', 'left', ...
        'backgroundcolor', [1.00 1.00 1.00], ...
        'position', [ ...
            label_origin ...
            (row - 1)*(row_height + padding) ...
            label_width ...
            row_height ...
            ] ...
        );
    ...
    row = 5;
    rct_window_level_handles.level_selector = uicontrol( ...
        'parent', main_window, ...
        'style', 'slider', ...
        'units', 'points', ...
        'tag', 'level', ...
    ...
    row = 4;
    rct_window_level_handles.level_scale_label_left = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        ...
        'position', [ ...
            scale_label_origin ...
            ((row - 1)*(row_height + padding) + scale_label_padding) ...
            scale_label_width ...
            row_height ...
            ] ...
        );
    ...
    row = 4;
    rct_window_level_handles.level_scale_label_right = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        ...
        'backgroundcolor', [1.00 1.00 1.00], ...
        'position', [ ...
            (scale_label_origin + scale_label_width) ...
            ((row - 1)*(row_height + padding) + scale_label_padding) ...
            scale_label_width ...
            row_height ...
            ] ...
    ...
    row = 3;
    rct_window_level_handles.window_label = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
        'tag', 'window_label', ...
        'string', sprintf("Window: %d", window_value), ...
        'horizontalalignment', 'left', ...
        'backgroundcolor', [1.00 1.00 1.00], ...
        'position', [ ...
            label_origin ...
    ...
    row = 2;
    rct_window_level_handles.window_selector = uicontrol( ...
        'parent', main_window, ...
        'style', 'slider', ...
        'units', 'points', ...
        'tag', 'window', ...
    ...
    row = 1;
    rct_window_level_handles.window_scale_label_left = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
    ...
    row = 1;
    rct_window_level_handles.window_scale_label_right = uicontrol( ...
        'parent', main_window, ...
        'style', 'text', ...
        'units', 'points', ...
