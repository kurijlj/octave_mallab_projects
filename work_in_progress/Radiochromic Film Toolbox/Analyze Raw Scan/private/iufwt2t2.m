function [f, cvr] = iufwt2t2(ca, cv, par, varargin)
...
% AUTHOR: Zdenek Prusa
    ...
    if(isstruct(par) && isfield(par, 'fname'))
       complainif_toomanyargs(nargin, 3, 'IUFWT');
       ...
       complainif_notenoughargs(nargin, 4, 'IUFWT');
    ...
    %%  Run computation
    [f, cvr] = comp_iufwt2(ca, cv, w.g, w.a, J, scaling);
