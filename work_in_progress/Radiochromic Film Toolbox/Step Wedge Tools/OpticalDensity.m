...
% -----------------------------------------------------------------------------
            ...
            % Check if column index is within pixel data bounds
            if(size(od.pd)(2) < x)
                error( ...
                    sprintf( ...
                        cstrcat( ...
...
% -----------------------------------------------------------------------------
            ...
            % Validate value supplied for the Row -----------------------------
            validateattributes( ...
                y, ...
                {'numeric'}, ...
                { ...
            ...
            % Check if row index is within pixel data bounds
            if(size(od.pd)(1) < y)
                error( ...
                    sprintf( ...
                        cstrcat( ...
...
% -----------------------------------------------------------------------------
            fname = 'inplot';
            use_case_a = ' -- IP = od.inplot()';
            use_case_b = ' -- IP = od.inplot(..., "PROPERTY", VALUE, ...)';
            ...
            % If resolution is set convert column indexes to given distance
            % units
            xscale = 1:1:size(IP, 1);
            switch(od.rslu)
                case 'dpi'
                    xscale = (xscale.*25.4)./od.rsl(2);

                case 'dpcm'
                    xscale = (xscale.*10.0)./od.rsl(2);
        ...
        function crossplot(od, varargin)
% -----------------------------------------------------------------------------
%
% Method 'crossplot':
%
...
% -----------------------------------------------------------------------------
            fname = 'crossplot';
            use_case_a = ' -- CP = od.crossplot()';
            use_case_b = ' -- CP = od.crossplot(..., "PROPERTY", VALUE, ...)';
            ...
            % Validate value supplied for the row index
            if(size(od.pd)(1) < y)
                error( ...
                    sprintf( ...
                        cstrcat( ...
