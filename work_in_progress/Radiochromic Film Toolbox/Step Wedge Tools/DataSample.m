...
%  ----------------------------------------------------------------------------
        ...
        function result = stderr(ds, cl=1)
%  ----------------------------------------------------------------------------
%
%  Method 'stderr':
%
...
%
%  Description:
%          Overload equality operator (==) for the DataSample class. It wraps
%          'isequal' method.
%
%  ----------------------------------------------------------------------------
            fname = 'eq';
...
%
%  Description:
%          Overload non equality operator (!=) for the DataSample class. It
