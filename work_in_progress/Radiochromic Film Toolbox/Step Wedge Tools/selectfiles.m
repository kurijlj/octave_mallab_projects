function cstrfpaths = selectfiles(FLT={}, DIALOG_NAME='')
%% -----------------------------------------------------------------------------
%%
...
%
%  Use:
%       -- cstrfpaths = selectfiles()
%       -- cstrfpaths = selectfiles(FLT)
%       -- cstrfpaths = selectfiles(FLT, DIALOG_NAME)
%
%% Description:
%       Return a cell array containig absolute paths to the selected files. It
%       invokes 'uigetfile' function to provide interface for multiple files
