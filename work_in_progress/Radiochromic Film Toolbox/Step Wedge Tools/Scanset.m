...
% -----------------------------------------------------------------------------
            ...
            if(ss.isvalid() && other.isvalid())
                ...
                if( ...
                        size(ss.pd, 3) == size(other.pd, 3) ...
                        && 10 >= abs( ...
                            size(ss.pd, 2) - size(other.pd, 2) ...
                            ) ...
                        && 10 >= abs( ...
                            size(ss.pd, 1) - size(other.pd, 1) ...
                            ) ...
            ...
            delta = size(ss.pd, 1) - size(other.pd, 1);
            if(0 ~= delta)
                warning( ...
                    sprintf( ...
                        cstrcat( ...
            ...
            delta = size(ss.pd, 2) - size(other.pd, 2);
            if(0 ~= delta)
                warning( ...
                    sprintf( ...
                        cstrcat( ...
