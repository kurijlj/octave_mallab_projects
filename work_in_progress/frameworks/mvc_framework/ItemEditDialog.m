...
%
% Use:
%       -- handles = ItemEditDialog(name, uistyle, item)
%
% Description:
%          Demo and functionality test dialog for the ItemEditView view.
%
% -----------------------------------------------------------------------------
function handles = ItemEditDialog(name, uistyle, item)
    fname = 'ItemEditDialog';
    use_case_a = ' -- handles = ItemEditDialog(name, uistyle, item)';
